...
const testimonials = [
  {
    ...
    quote:
      "MedConnect has transformed how I manage my practice. The intuitive interface and powerful scheduling tools save me hours every week.",
  },
  {
    name: "James Wilson",
    role: "Patient",
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0a0d17] via-[#111827] to-[#0a0d17] text-white">
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Hear from healthcare professionals and patients who use MedConnect every day
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative p-8 md:p-12 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join thousands of healthcare professionals who are streamlining their workflow with MedConnect.
            </p>
      ...
      <footer className="border-t border-gray-800 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">© {new Date().getFullYear()} MedConnect</p>
